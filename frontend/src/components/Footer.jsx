      ...
      <div className="footer-content">
        ...
        <div className="footer-section links">
          ...
          <ul>
            ...
            <Link to="/privacypolicy"><li onClick={() => window.scrollTo(0, 0)}>Privacy Policy</li></Link>
            <Link to="/shippingpolicy"><li onClick={() => window.scrollTo(0, 0)}>Shipping Policy</li></Link>
            <Link to="/termsandconditions"><li onClick={() => window.scrollTo(0, 0)}>Terms & Conditions</li></Link>
            <Link to="/cancellationandrefundpolicy"><li onClick={() => window.scrollTo(0, 0)}>Cancellation & Refund Policy</li></Link>
